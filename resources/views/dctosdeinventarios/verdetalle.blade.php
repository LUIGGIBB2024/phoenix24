...
<div class="app-page-title">
    <h4 id = "encab_pagina">Detalle del Pedido N°::{{ str_pad($documentos->consecutivo,10,"0",STR_PAD_LEFT)}} :: Valor $:{{number_format($documentos->totaldocumento)}}</h4>
    <div class="page-title-wrapper">
        <div class="ibox-tools">
            <a href="javascript:window.history.go(-1)">
                <button class="btn btn-warning btn-xs" type="button" style="font-size:15px;position:absolute;right:0ch;margin-top:-2%;">
                   ...
                   <table class ="table table-striped responsive" id="datadetalles">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class = "enc_datatable">Valor Movimiento</th>
...
@section('js')
    ...
    {
        let dataid = <?php echo 	$documentos->documentosdeinventariosID; ?>;
        let cadenaruta  = "{{route('dctosverdetalle.ajax',['id' => 'var1'])}}";
        ...
        var datavtas =  $('#datadetalles').DataTable(
           {
                ...
                "columns":[
                    {data:'movimientosdeinventariosID'},
                    {data:'producto'},
                    {data:'descripcion'},
                    {data:'bodega'},
                    {data:'cantidad',render:$.fn.dataTable.render.number(',', '.', 2, ''),className:"text-right"},
                    {data:'costoreal',render:$.fn.dataTable.render.number(',', '.', 2, ''),className:"text-right"},
                    ...
                    {data:'ivaproducto',render:$.fn.dataTable.render.number(',', '.', 0, ''),className:"text-right"},
