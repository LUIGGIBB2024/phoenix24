...
@section('title','Consultar Pedidos|Enlace Visual')
...
<div>
    <h4 id = "encab_ventas" class="color_infoencab">Consultar Información de Pedidos :: Total $:<span id="totalpedidos"></span></h4>
    <div >
        @php
           $fecha = date('Y-m-d');
        @endphp
...
<div class="app-page-title" style="height: 100px;">
    ...
    <div class="form-group contenedor_fechas">
        <div class="container">
            ...
            <button type="button" id = "filtrarpedidos" class="btn btn-danger" >Generar Consulta</button>
        </div>
    </div>
</div>
    ...
    <div class="row">
         <div class="col-lg-12" >
              <div class="table-responsive">
                   <table class ="table table-striped responsive" id="datapedidos">
                        <thead class="thead-light">
                            <tr>
                                <th class = "enc_datatable">ID</th>
                                <th class = "enc_datatable" style="width:5%;">Fecha Pedido</th>
                                <th class = "enc_datatable" style="width:5%;">Nro Placa</th>
                                <th class = "enc_datatable">Nro Pedido</th>
                                ...
                                <th class = "enc_datatable">Total Pedido</th>
...
@section('js')
    ...
    $(document).ready(function()
    {
        ...
        $(document).on('click', '#filtrarpedidos', function()
        {
        ...
        function procesar_informacion(query = '',xfecha1,xfecha2)
        {
          ...
          let cadenaruta  = "{{ route('pedidos.ajax',['fecha1' => 'var1', 'fecha2' => 'var2'])}}"
          cadenaruta = cadenaruta.replace('var1',mfecha1)
          cadenaruta = cadenaruta.replace('var2',mfecha2)

         var datavtas =  $('#datapedidos').DataTable(
           {
                ...
                "columns":[
                    ...
                    {data:'totalpedido',render:$.fn.dataTable.render.number(',', '.', 0, '$'),className:"text-right"},
                    {data: 'estadopedido'},
                    {data: 'btn'}
                ],
               "pageLength": 8,
