<div class="app-header color-header">
    <div class="app-header__logo">
        {{-- <div class="logo-src logoempresa"></div>--}}
        <div class="navbar-header color-header" >
            <a class="navbar-brand color-header" href="./" style="text-align: center;"><img width="60%" src="{{asset('img/logo.png')}}" alt="Logo"  ></a>
       </div>
                ...
                <div class="widget-content p-0">
                    <div class="widget-content-wrapper">
                        <div class="widget-content-left">
                            <div class="btn-group">
                                <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0">
                                    <img  width="40" class="user-avatar rounded-circle" src="{{ asset('img/usuarioconectado.jpg')}}" alt="User Avatar">
                                            ...
                                            <div class="menu-header-content text-left">
                                                <div class="widget-content p-0">
                                                    <div class="widget-content-wrapper">
                                                        ...
                                                        <div class="widget-content-left">
                                                            <div style="font-size: 9px !important">{{Auth::user()->name}}</div>
                        ...
                        <div class="widget-content-left  ml-3 header-user-info">
                            <div class="widget-heading" style="font-size:11px;">
