            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-life-ring"></i><a href="{{url('inventarios/consultar_saldos')}}">Saldos por Productos1</a></li>
                        <li><i class="menu-icon fa fa-list-alt"></i><a href="{{url('invinventarios/consultar')}}">Saldos Totales</a></li>
