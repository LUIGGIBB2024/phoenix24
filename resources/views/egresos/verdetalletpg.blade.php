                   ...
                   <table class ="table table-striped" id="datadetalle">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class = "enc_datatable">CPTO</th>
                                <th class = "enc_datatable">Tipo de Pago</th>
                                <th class = "enc_datatable">Cuenta</th>
                                <th class = "enc_datatable">Valor Pago</th>
       ...
       $(document).ready(function()
        {
           ...
           let cadenaruta  = "{{route('verpagosegresostpg.ajax',['id' => 'var1'])}}";
           ...
           var datacxpadet =  $('#datadetalle').DataTable(
               {
                   ...
                   "columns":[
                       {data:'id'},
                       {data:'fechadocumento'},
                       {data:'nittercero',"width":"8%"},
                       {data:'nombrecompleto',"width":"50%"},
                       {data:'conceptodepago',"width":"30px"},
                       {data:'descripcionconceptodepago',"width":"35%"},
                       {data:'cuenta',"width":"50px"},
