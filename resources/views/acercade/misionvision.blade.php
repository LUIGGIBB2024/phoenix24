...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <style>
        ...
        body {
            background-image: url("https://demo.themexbd.com/rtl/alternat/wp-content/uploads/2021/06/disti-process-s.png");
            opacity: 1;
            background-size: cover;
            background-position: center;
            background-color: rgba(16, 70, 187, 0.3);
  ...
  <body>
    <div class="page1"><a class="banner banner-top" href="#" target="_blank1"><img src="" alt="" height="0"></a>
                            ...
                            <div class="rd-navbar-main">
                                ...
                                <div class="rd-navbar-main-element" >
                                    ...
                                    <ul class="rd-navbar-nav">
                                        <li class="rd-nav-item active"><a class="rd-nav-link" href="{{ route('inicio') }}">Inicio</a></li>
                                        <li class="rd-nav-item"><a class="rd-nav-link" href="{{ route('acercade') }}">Quienes Somos</a></li>
                                        <li class="rd-nav-item"><a class="rd-nav-link" href="{{ route('mision') }}">Misión/Visión</a></li>
                                    </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row row-30 justify-content-xl-between">
              <div>
                  <ul class="list-lg">
                    <li>
                      <section>
                        <div class="heading-5 encabezado0">MISIÓN</div>
                        <div class="row" >
                            <div class="col-lg-6">
                                <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light" style="padding:5px;">
                                    <img class="imagen_01" src="{{asset('img/varios/imagenmisionvision.png')}}" class="img-fluid" width="100%" style="height:185px;" />
                                    <a href="#!">
                            ...
                            <div class="col-lg-6">
                                <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                                    <p class="big txt_columna2">En La <strong>Distribuidora Barfacar S.A.S. y Serviteca Barfacar</strong> Somos una empresa líder en el <strong>mercado regional del Cesar y La Guajira</strong> en servicios y comercialización de Autopartes, Baterías, llantas y Lubricantes; cuenta con un excelente portafolio de productos y servicios enfocados a brindar la mejor Calidad. <strong>A partir de sus principios, valores y recurso humano</strong> nos hemos esforzado en mantener un buen reconocimiento por parte de nuestros clientes y proveedores regionales y nacionales y que a través del desarrollo y mejoramiento continuo de nuestros procesos internos queremos brindar la mejor experiencia en sector de autopartes</p>
                                </div>
                            </div>
                        </div>
                      </section>
                      <section>
                        <div class="heading-5 encabezado1">VISIÓN</div>
                        <div class="row" >
                            <div class="col-md-6">
                                <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light" style="padding:5px;">
                                    <img class="imagen_02" src="{{asset('img/varios/imagenvision.jpg')}}" class="img-fluid" width="100%" style="height:185px;" />
                                    <a href="#!">
                                      <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                                    </a>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                                    <p class="big txt_columna2">En la <strong>Distribuidora Barfacar S.A.S y Serviteca Barfacar</strong> trabajamos para ser Reconocidos como referentes en la zona del <strong>Cesar y La Guajira</strong> en la Prestación de los <strong>servicios de mantenimiento preventivo y comercialización de autopartes, Baterías, Lubricantes y Llantas,</strong> mediante estrategias que garanticen una buena rentabilidad a la empresa manteniendo los mejores precios del mercado sin afectar la calidad de los productos y servicios. </p>
                                </div>
                            </div>
                        </div>
                      </section>
                      <section>
                        <div class="heading-5 encabezado1">NUESTROS VALORES</div>
                        <div class="row" >
                            <div class="col-md-6">
                                <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light" style="padding:5px;">
                                    <img class="imagen_03" src="{{asset('img/varios/imagenvalores.png')}}" class="img-fluid" width="100%" style="height:185px;" />
                                    <a href="#!">
                                      <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                                    </a>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="container" style="display:flex;">
                                    <div>
                                       <ul>
                                           <li>
                                               <i class="fad fa-check-circle desglose_portafolio2">La Integridad</i>
                                           </li>
                                           <li>
                                               <i class="fad fa-check-circle desglose_portafolio2">El servicio</i>
                                           </li>
                                           <li>
                                           <i class="fad fa-check-circle desglose_portafolio2">La Honestidad</i>
                                           </li>
                                           <li>
                                               <i class="fad fa-check-circle desglose_portafolio2">El Respeto</i>
                                           </li>
                                           <li>
                                               <i class="fad fa-check-circle desglose_portafolio2">La Tolerancia</i>
                                           </li>
                                           <li>
                                               <i class="fad fa-check-circle desglose_portafolio2">La Responsabilidad</i>
                                           </li>
                                           <li>
                                               <i class="fad fa-check-circle desglose_portafolio2">La Confianza</i>
                                           </li>
                                           <li>
                                               <i class="fad fa-check-circle desglose_portafolio2">El Compromiso</i>
                                        </li>
                                       </ul>
                                   </div>
                                 </div>
