...
@section('title','Consultar CxP|Enlace Visual')
...
<div class="app-page-title">
    ...
    <h4 class="color_infoencab">Total Cuentas x Pagar :: Total:$: <span id="totalcxp"></h4>
</div>
    ...
    <div class="row">
         <div class="col-md-12">
              <div class="table-responsive">
                   <table class ="table table-striped" id="datacxp">
                        <thead class="thead-light">
                            <tr>
                                <th class = "enc_datatable">ID</th>
                                <th class = "enc_datatable">Nombre del Proveedor</th>
...
@section('js')
    ...
    <script>
        ...
        {
        var datacartera =  $('#datacxp').DataTable(
            {
