...
@section('title','Detalle de CxP|Enlace Visual')
...
<div class="app-page-title">
    ...
    <h4 id = "encab_pagina" class="color_infoencab"> Información Detallada para :: {{$nombredeltercero}} >> Saldo $:{{ number_format($saldo) }} </h4>
...
@section('js')
    ...
    <script>
        $(document).ready(function()
        {
           ...
           let cadenaruta  = "{{route('cxpverdetalle.ajax',['id' => 'var1'])}}";
