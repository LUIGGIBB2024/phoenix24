...
@section('title','Detalle de Recibos|Enlace Visual')
...
<div class="app-page-title" >
    <h4 id = "encab_pagina" style="margin-top:-5px;"> Detalle del Recibo ::{{ $recibos->consecutivo."-".$recibos->tipodocumento}}::Valor de Recibo $: {{ number_format($recibos->valorefectivo+$recibos->valorotro)}} / {{ $recibos->nombredelcliente}}  </h4>
    <div class="page-title-wrapper">
        <div class="ibox-tools">
            <a href="javascript:window.history.go(-1)">
                <button class="btn btn-warning btn-xs" type="button" style="font-size:15px;position:absolute;right:0ch;margin-top:-2.8ch;">
                   ...
                   <table class ="table table-striped" id="datadetalle">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class = "enc_datatable">Fecha Recibo</th>
                                ...
                                <th class = "enc_datatable">Abono a Cartera</th>
                            </tr>
                        </thead>
                   </table>
              </div>
...
@section('js')
    ...
    <script>
        ...
        {
           let dataid = <?php echo 	$recibos->id; ?>;
           let cadenaruta  = "{{route('verpagosrecibos.ajax',['id' => 'var1'])}}";
