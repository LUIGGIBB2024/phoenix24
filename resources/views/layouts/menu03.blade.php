                ...
                <nav class="navbar navbar-expand-sm navbar-default">
                    <div id="main-menu" class="main-menu collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            <li class="active">
                                <a href="index.html"><i class="menu-icon pe-7s-science"></i>Dashboard </a>
                            </li>
                            ...
                            <li class="menu-item-has-children dropdown">
                                ...
                                <ul class="sub-menu children dropdown-menu">
                                    ...
                                    <li><i class="menu-icon fa fa-list"></i><a href="ui-buttons.html">Reportar Entregas</a></li>
                               </ul>
                            </li>
                            <li class="menu-item-has-children dropdown">
                                ...
                                <ul class="sub-menu children dropdown-menu">
                                    <li><i class="menu-icon fa fa-money"></i><a href="ui-buttons.html">Cartera Resumida</a></li>
                                    <li><i class="menu-icon fa fa-map-marker"></i><a href="ui-badges.html">Google MAP</a></li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children dropdown">
                                ...
                                <ul class="sub-menu children dropdown-menu">
                                    <li><i class="menu-icon fa fa-book"></i><a href="ui-buttons.html">CxP Resumida</a></li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children dropdown">
                                ...
                                <ul class="sub-menu children dropdown-menu">
                                    <li><i class="menu-icon fa fa-id-card-o"></i><a href="tables-basic.html">Rc Caja Detallados</a></li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children dropdown">
                                ...
                                <ul class="sub-menu children dropdown-menu">
                                    <li><i class="menu-icon fa fa-address-book-o"></i><a href="forms-basic.html">Egresos Detallados</a></li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-cart-plus"></i>Pedidos</a>
                                <ul class="sub-menu children dropdown-menu">
                                    <li><i class="menu-icon fa fa-cart-plus"></i><a href="font-fontawesome.html">Consultar Pedidos</a></li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children dropdown">
                                ...
                                <ul class="sub-menu children dropdown-menu">
                                    <li><i class="menu-icon fa fa-camera-retro"></i><a href="font-fontawesome.html">Productos (Fotos)</a></li>
                                    <li><i class="menu-icon fa fa-map-o"></i><a href="font-fontawesome.html">Ubicación (Clientes)</a></li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children dropdown">
                                ...
                                <ul class="sub-menu children dropdown-menu">
                                    <li><i class="menu-icon fa fa-line-chart"></i><a href="charts-chartjs.html">Ventas Mensuales</a></li>
            ...
            <div id="right-panel" class="right-panel">
                        ...
                        <div class="header-menu">
                            ...
                            <div class="user-area dropdown float-right">
                                ...
                                <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img class="user-avatar rounded-circle" src="{{asset('img')}}/usuarios/{{Auth::user()->avatar}}" alt="User Avatar">
                                </a>
                    ...
                    <div class="animated fadeIn">
                                        ...
                                        <div class="stat-widget-five">
                                            ...
                                            <div class="stat-content">
                                                <div class="text-left dib">
                                                    <div class="stat-text">$<span class="count">23569100</span></div>
                                        ...
                                        <div class="stat-widget-five">
                                            ...
                                            <div class="stat-content">
                                                <div class="text-left dib">
                                                    ...
                                                    <div class="stat-heading">Cartera</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="box-title">Ventas Mensuales</h4>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div class="card-body">
                ...
                <footer class="site-footer">
                    <div class="footer-inner bg-white">
                        <div class="row">
                            <div class="col-sm-6">
                                Copyright &copy; 2021 Enlace Visual
                            </div>
