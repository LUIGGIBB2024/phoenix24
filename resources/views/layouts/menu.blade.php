        ...
        <meta charset="utf-8">
            <meta content="width=device-width, initial-scale=1" name="viewport">
                ...
                <meta content="{{ csrf_token() }}" name="csrf-token">
                    ...
                    @yield('css')
                    <link rel="stylesheet" href="{{ asset('css/menuside.css')}}">
                    <link rel="stylesheet" href="{{ asset('css/all.min.css')}}">


                    <!-- <link rel="stylesheet" href="{{ asset('css/bootstrap.min.css') }}" /> -->
                    <script defer="" src="{{ asset('js/menuside/popper.js') }}"></script>
                    ...
                    <script defer="" src="{{ asset('js/globalteam.js') }}"> </script>
                    <script defer="" src="{{ asset('js/demo.js') }}"></script>
                    <script defer="" src="{{ asset('js/menuside.js') }}"></script>
                    <script defer="" src="{{ asset('front_page/editor.js') }}"></script>
                    <!-- Fonts -->
                    ...
                    <link rel="stylesheet" href="{{asset('css/menuside/style.scss')}}">
