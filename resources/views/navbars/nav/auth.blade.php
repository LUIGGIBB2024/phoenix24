...
@php
    if (!isset($titlePage))
    {
        $titlePage = "Usuario Activo - Cierre la Sesión por Favor";
    }
...
<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
  <div class="container-fluid">
    <div class="navbar-wrapper">
      <a class="navbar-brand" style="color:rgb(110, 20, 194);" href="#"><strong>{{$titlePage}}</strong></a>
    </div>
    ...
    <div class="collapse navbar-collapse justify-content-end">
      <form class="navbar-form" style="display:none">
        <div class="input-group no-border " wire:key="input-group-search">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
            ...
            <a class="dropdown-item" href="#">{{ __('Configurar') }}</a>
