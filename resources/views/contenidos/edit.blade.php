...
<div>
    <h4 class="color_infoencab">Modificar Imágenes de Contenidos</h4>
</div>
...
<div class='col-md-8'>
    {{ Form::model($contenidos,array('route' => array('contenidos.update', $contenidos->id), 'method' => 'PUT','enctype' => 'multipart/form-data')) }}
    {{--{{ Form::model($contenidos,['route' => ['contenidos.update',$contenidos->id],'method' => 'PUT','files' => true,'enctype' => 'multipart/form-data','style'=>'text-align:left'])}}--}}
        {{csrf_field()}}
        ...
        <div class="form-group">
            {{ Form::label('titulo', 'Titulo de la Imagen:'), array('class' => 'form-control-label')}}
            {{ Form::text('titulo',null, array('class' => 'form-control')) }}
        </div>
        <div class="form-group">
            {{ Form::label('pagina', 'Página:'), array('class' => 'form-control-label') }}
            {{ Form::text('pagina',null, array('class' => 'form-control')) }}
        </div>
        <div class="form-group">
            {{ Form::label('idcontenido', 'Id de la Foto:'), array('class' => 'form-control-label')}}
