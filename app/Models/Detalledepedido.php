...
class Detalledepedido extends Model
{
    ...
    protected $fillable = [
    'consecutivo','tipodedocumento','fechadocumento','nit','sucursal','proyecto','sproyecto','centrooper','lapso','nittercero','rutadeventa','zonadeventa','tipocliente','vendedor','lista','tecnico',
