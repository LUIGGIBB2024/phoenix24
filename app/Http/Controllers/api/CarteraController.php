...
class CarteraController extends Controller
{
    ...
    public function CarteraResumida(Request $request):JsonResponse
    {
        ...
        $cartera = cartera::selectRaw("clientes.nombrecompleto, SUM(cuentasporcobrar.valorfactura) as total")
                  ->join('clientes', ['cuentasporcobrar.nit',"=",'clientes.nit'],['cuentasporcobrar.sucursal',"=",'clientes.sucursal'])
                  //->join('clientes as b', 'cuentasporcobrar.sucursal',"=",'b.sucursal')
                  //->where('cuentasporcobrar.sucursal','clientes.sucursal')
